...
Bootstrapper.prototype._startServer = function (cluster) {
    ...
    return self._initWinston().then(function () {
        ...
        console.log("jsreport server successfully started on port: "  + (self.config.httpsPort ? self.config.httpsPort : self.config.httpPort));
    });
};
