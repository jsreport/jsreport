...
var paperSize = {
    format: system.args[11] != "null" ? system.args[11] : "",
    orientation: system.args[8],
    margin: system.args[3] != "null" ? system.args[3] :  "1cm",
};

if (system.args[9] != "null") {
    paperSize.width = system.args[9];
}

if (system.args[10] != "null") {
    paperSize.height = system.args[10];
}
