...
describe('assets', function () {
  ...
  it('should expose handlebars asset helper supporting nested assets', async () => {
    await reporter.documentStore.collection('assets').insert({
      name: 'foo.html',
      content: '{{asset "foo2.html"}}'
    })
    ...
    res.content.toString().should.be.eql('foo2 content')
  })

  it('should expose handlebars asset helper supporting nested assets with proper error decorations', async () => {
    await reporter.documentStore.collection('assets').insert({
      name: 'foo.html',
      content: '{{asset "foo2.html"}}'
    })
    ...
    try {
      ...
      e.entity.name.should.be.eql('foo2.html')
    }
  })

  it('should expose jsrender asset helper supporting nested assets', async () => {
    await reporter.documentStore.collection('assets').insert({
      name: 'foo.html',
      content: '{{:~asset("foo2.html")}}'
    })
