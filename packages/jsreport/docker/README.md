...
>
- `jsreport/jsreport:4.14.2` ([Dockerfile](https://github.com/jsreport/jsreport/blob/4.14.2/packages/jsreport/docker/default/Dockerfile))  contains default installation from npm
- `jsreport/jsreport:4.14.2-full` ([Dockerfile](https://github.com/jsreport/jsreport/blob/4.14.2/packages/jsreport/docker/full/Dockerfile)) contains default installation plus all the custom extensions, see the list of installed extensions in the dockerfile
- `jsreport/jsreport:4.14.2-windowsservercore` ([Dockerfile](https://github.com/jsreport/jsreport/blob/4.14.2/packages/jsreport/docker/windowsservercore/Dockerfile)) contains default installation with windows server core based image. Use `c:\jsreport` for mounting volume.
...
2. `sudo docker run -p 80:5488 jsreport/jsreport:4.14.2`
