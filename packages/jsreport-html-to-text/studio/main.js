...
var HtmlToTextProperties = function (_Component) {
  _inherits(HtmlToTextProperties, _Component);

  function HtmlToTextProperties() {
    _classCallCheck(this, HtmlToTextProperties);

    return _possibleConstructorReturn(this, (HtmlToTextProperties.__proto__ || Object.getPrototypeOf(HtmlToTextProperties)).apply(this, arguments));
  }

  _createClass(HtmlToTextProperties, [{
    key: 'render',
  ...
  return HtmlToTextProperties;
}(_react.Component);

exports.default = HtmlToTextProperties;
