...
describe('xlsx generation - charts', () => {
  ...
  it('chart with source configured to table generated by loop (xlsxChart helper not used)', async () => {
    const data = [{
      category: 'Apples',
      serie1: 20,
      serie2: 40
  ...
  it('chartex with source configured to table generated by loop (xlsxChart helper not used)', async () => {
    const data = [{
      category: 'Category1',
      value: 20
    }, {
